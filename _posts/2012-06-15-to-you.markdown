...
<div class="audiocontainer">
	...
	<audio src="http://files.qingpei.me/a/%E7%BB%99%E4%BD%A0_edwardtoday.mp3" type="audio/mp3" controls="controls">
	<itext id="lyrics_a" lang="zh" type="text/lrc" display="yes" src="/song/lrc/%E7%BB%99%E4%BD%A0_edwardtoday.lrc" category="LRC"></itext>
	</audio>
	<h1 id="lyricsline"></h1>
	</div>
</div>
