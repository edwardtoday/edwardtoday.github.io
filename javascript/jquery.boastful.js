    ...
    $.fn.boastful = function(options) {
        ...
        var parse_request = function(data) {
            ...
            if (data.response.list.length > 0) {
                $.each(data.response.list,
                function(i, tweetback) {
                    ...
                    $('.boastful').mouseover(function() {
                        $(this).children('.boastful_tweet, .boastful_pointer').show()
                    })
                    ...
                    $('.boastful').mouseout(function() {
                        $(this).children('.boastful_tweet, .boastful_pointer').hide()
                    })
                });
            } else {
